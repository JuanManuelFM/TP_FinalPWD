...
?>
  <div class="col-12 container row py-2">
    <?php
    foreach ($productos as $objProducto) {
      ?>
      <div class="caja_producto col-4 py-2">
        ...
        <div class="titulo_producto text-center">
          <h6 style="display: inline-block;"><?= $objProducto->getProNombre() . " - $" .  $objProducto->getProPrecio() ?></h6>
        </div>
          ...
          <div class="container align-items-center " style="margin-top: 50px;">
            <table class="table table-hover table-bordered">
              ...
              <tbody>
                ...
                <div>
                  <?php
                  $controlCompraItem->crearCarrito($objSession->getUsuario()->getIdUsuario());
                  ?>
                </div>
              </tbody>
            </table>
